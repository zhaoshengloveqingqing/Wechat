...
function pinet_send_randcode($code, $mobile, $tpl_id=1){
	$default_agent_cfg = C('default_agent_info');
	$apikey = $default_agent_cfg['sms_apikey'];
	$company = $default_agent_cfg['sms_company'];
	$tpl_value="#code#=$code";
	return tpl_send_sms($apikey, $tpl_id, $tpl_value, $mobile);
}

function pinet_send_randcode_nocompany($code, $mobile, $tpl_id=550169){
    $default_agent_cfg = C('default_agent_info');
    $apikey = $default_agent_cfg['sms_apikey'];
    $tpl_value="#code#=$code";
    return tpl_send_sms($apikey, $tpl_id, $tpl_value, $mobile);
...
function pinet_generate_shorturl($url){
