<?php
class UpyunAction extends BackAction{
	public $token;
	public $bucket;
	...
	function localUpload($filetypes=''){
		...
		//
		if (!is_dir($_SERVER['DOCUMENT_ROOT'].'/uploads/'.$firstLetter.'/'.$this->token)){
			mkdir($_SERVER['DOCUMENT_ROOT'].'/uploads/'.$firstLetter.'/'.$this->token, 0775, true);
		}
		//
