<?php
class GoldenAction extends BaseAction
{
	...
	public function getajax(){	
		...
		if ($record['usenums'] >= $Lottery['canrqnums'] ) {
			...
			if ($prizetype >= 1 && $prizetype <= 6) {				 
				...
				echo '{"success":1,"sn":"'.$sn.'","prize":"'.$prize.'","prize_type":"'.$prize_type.'","usenums":"'.$usenums.'"}';
			}else{
